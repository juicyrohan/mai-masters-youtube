...
Было проведено сравнение качества моделей по различным наборам признаков. Лучшие результаты для каждой модели (в данном случае использовали метод пересемплирования SMOTE):
...
!!! Можно попробовать другие метрики качества !!! <br>
!!! Можно попробовать ансамблевые методы !!! <br>
На следующем этапе иссследования планируется построить классификатор для 3 групп комментариев (обычные, боты, тролли). <br>
